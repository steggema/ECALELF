...
RerecoGlobalTag = cms.ESSource("PoolDBESSource",
        ...
        cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                 tag = cms.string("EcalIntercalibConstants_Run2017BCDEF_run297056_eopPNEB_v1"),
                 connect = cms.string("sqlite_file:/eos/cms/store/group/dpg_ecal/alca_ecalcalib/IC_tags/Cal_UL2017/EcalIntercalibConstants_Run2017BCDEF_run297056_eopPNEB_v1.db")
                 ),
        ...
        cms.PSet(record = cms.string("EcalPFRecHitThresholdsRcd"),
                 tag = cms.string("EcalPFRecHitThresholds_UL_2017_mc_v2"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                 ),
