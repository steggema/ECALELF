...
RerecoGlobalTag = cms.ESSource("PoolDBESSource",
        ...
        cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                 tag = cms.string("EcalIntercalibConstants_Run2018ABCD_run297056_eopPNEB_Combination_withFinalReg_withEtaScalePreliminary_v2"),
                 connect = cms.string("sqlite_file:/eos/cms/store/group/dpg_ecal/alca_ecalcalib/IC_tags/Cal_UL2018/EcalIntercalibConstants_Run2018ABCD_run297056_eopPNEB_Combination_withFinalReg_withEtaScalePreliminary_v2.db")
                 ),
