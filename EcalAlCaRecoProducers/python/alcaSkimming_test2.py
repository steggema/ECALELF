...
options.register ('tagFile',
                  ...
                  "../config/reRecoTags/102X_dataRun2_Prompt_v1.py",
                  VarParsing.VarParsing.multiplicity.singleton,
                  VarParsing.VarParsing.varType.string,
...
#options.files= "file:/eos/cms/store/group/dpg_ecal/alca_ecalcalib/ecalelf/alcarereco/13TeV/102X_dataRun2_Prompt_v1/EGamma-Run2018D-ZSkim-Prompt-v2/320500-320887/EcalRecalElectron-1-1-fab1.root"
#options.files= "/store/data/Run2018D/EGamma/ALCARECO/EcalUncalZElectron-PromptReco-v2/000/320/674/00000/20F82BE5-F997-E811-B597-02163E019F46.root"
options.files= "file:20F82BE5-F997-E811-B597-02163E019F46.root"
...
if(len(options.jsonFile)>0): # this works only in local
    ...
    print "about to assign lumisToProcess"
    print "JSON file name ",options.jsonFile
    process.source.lumisToProcess = LumiList.LumiList(filename = options.jsonFile).getVLuminosityBlockRange()
#    print "printing all the lumis", process.source.lumisToProcess
