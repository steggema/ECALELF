...
newRegression = False
usenewSCregressionFromSam=True ### regression provided by Sam on April 30th
#yearRegress="2018UL"
yearRegress="2016UL"
...
options.register ('tagFile',
                  "",
                  #"../config/reRecoTags/101X_dataRun2_Prompt_v9.py",
                  VarParsing.VarParsing.multiplicity.singleton,
                  VarParsing.VarParsing.varType.string,
...
process = cms.Process(processName,eras.Run2_2016)
#process = cms.Process(processName,eras.Run2_2017)
#process = cms.Process(processName,eras.Run2_2018)
...
###########NEW SC REGRESSION FROM SAM as on 30th April, 2019
if(usenewSCregressionFromSam):
    #dbFilename = "/eos/cms/store/group/phys_egamma/EgRegression/scReg_2017_UL_290419.db"
    #from CondCore.CondDB.CondDB_cfi import CondDB
    #CondDBReg = CondDB.clone(connect = 'sqlite_file:{}'.format(dbFilename))
    #process.scRegres = cms.ESSource(
    #    "PoolDBESSource",CondDBReg,
    ...
    process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.regressionKeyEB = cms.string('pfscecal_EBCorrection_offline_v3')
    process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.regressionKeyEE = cms.string('pfscecal_EECorrection_offline_v3')
    process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.uncertaintyKeyEB = cms.string('pfscecal_EBUncertainty_offline_v3')
    process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.uncertaintyKeyEE = cms.string('pfscecal_EEUncertainty_offline_v3')

    if yearRegress=="2018UL":
            process.particleFlowSuperClusterECAL.regressionConfig = cms.PSet(
                isHLT = cms.bool(False),
                applySigmaIetaIphiBug = cms.bool(False),
                ecalRecHitsEB = cms.InputTag("ecalRecHit","EcalRecHitsEB"),
            ...
            process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.regressionKeyEB = cms.string('pfscecal_EBCorrection_offline_v2')
            process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.regressionKeyEE = cms.string('pfscecal_EECorrection_offline_v2')
            process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.uncertaintyKeyEB = cms.string('pfscecal_EBUncertainty_offline_v2')
            process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.uncertaintyKeyEE = cms.string('pfscecal_EEUncertainty_offline_v2')



    if yearRegress=="2016UL":
            process.particleFlowSuperClusterECAL.regressionConfig = cms.PSet(
                isHLT = cms.bool(False),
                applySigmaIetaIphiBug = cms.bool(False),
                ecalRecHitsEB = cms.InputTag("ecalRecHit","EcalRecHitsEB"),
    ...
    process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.isHLT = cms.bool(False)
    process.eleNewEnergiesProducer.scEnergyCorrectorSemiParm.applySigmaIetaIphiBug  = cms.bool(False)
    

###########END OF USING NEW SC REGRESSION FROM SAM as on 30th April, 2019   
